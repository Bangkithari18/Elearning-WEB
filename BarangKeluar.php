                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right">
                            <div class="form-group">
                                <button type="button" class="btn btn-info btn-sm" onclick="AddBarangKeluar();">Add Data</button>
                            </div>
                        </div>
                    </div>
                    <table id="tbDataBarangKeluar" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>ID Keluar</th>
