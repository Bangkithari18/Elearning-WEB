...
$no = 1;
$query = "SELECT *, b.nama_barang AS nama_barang FROM tb_barang_masuk a INNER JOIN tb_barang b on a.barang_id = b.id_barang WHERE a.tanggal_masuk between '$Start' and '$End' ORDER BY a.id_masuk DESC";
